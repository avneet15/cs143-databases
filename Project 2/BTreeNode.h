...
class BTLeafNode {
  public:
    ...
    static const int KEY_SIZE = sizeof(int);
    static const int RECORD_ID_SIZE = sizeof(RecordId);
...
class BTNonLeafNode {
  public:
    ...
    */
    ...
    RC readEntryNonLeaf(int eid, int& key, PageId& pid);
